        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div custom={2} variants={fadeUp} className="grid sm:grid-cols-3 gap-6 mb-8">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="font-semibold">August 05 - 07, 2026</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="font-semibold">1600+ Attendees</p>
                </div>
              </div>
            </motion.div>
          ...
          >
            ...
            <h2 className="text-2xl font-bold text-white mb-6 text-center lg:text-center">
              Statistics of Innovest'25 (to be updated)
            </h2>
            <div className="grid grid-cols-2 gap-6 mb-8">
              {[
                { label: 'Masterclass', value: 'x+' },
                { label: 'Workshops', value: 'y+' },
                { label: 'Team Registered', value: 'z' },
                { label: 'School Students', value: 'aaaa+' },
              ].map((item, index) => (
                <motion.div
                  key={item.label}
                  variants={fadeUp}
